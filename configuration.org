...
** PDF Tools
   ...
   #+END_SRC
** Bongo
   Bongo is a flexible and usable media player for GNU Emacs. If you store your
   music collection locally and use structured file names, then Bongo is a great
   way for you to play music from within Emacs.
   #+BEGIN_SRC emacs-lisp
     (use-package bongo
       :config
       (setq bongo-prefer-library-buffers nil)
       (setq bongo-default-directory "~/Cloud/Music")
